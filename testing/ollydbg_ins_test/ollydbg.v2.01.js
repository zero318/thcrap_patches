{
	...
	// Miscellaneous options.
		...
		"NOP2_WSTR":			{ type: "w", val: "NOP2" },
		"LONG_NOP_WSTR":		{ type: "w", val: "LONG_NOP" },
		"HINT_NOP_WSTR":		{ type: "w", val: "HINT_NOP" },
		"ADDB_WSTR":			{ type: "w", val: "ADD_ALIAS" },
		"OR_ALIAS_WSTR":		{ type: "w", val: "OR_ALIAS" },
		"ADC_ALIAS_WSTR":		{ type: "w", val: "ADC_ALIAS" },
		"SBB_ALIAS_WSTR":		{ type: "w", val: "SBB_ALIAS" },
		"AND_ALIAS_WSTR":		{ type: "w", val: "AND_ALIAS" },
		"SUB_ALIAS_WSTR":		{ type: "w", val: "SUB_ALIAS" },
		"XOR_ALIAS_WSTR":		{ type: "w", val: "XOR_ALIAS" },
		"CMP_ALIAS_WSTR":		{ type: "w", val: "CMP_ALIAS" },
		
		"TAKEN_PREFIX_WSR":	{ type: "w", val: "TAKEN:" },
		"NTAKEN_PREFIX_WSTR":{ type: "w", val: "NTAKEN:" },
		"ALTER_PREFIX_WSR":	{ type: "w", val: "ALTER:" },
		
		"FCOM_WSTR":		{ type: "w", val: "FCOM" },
		"FCOMP_PREFIX_WSTR":{ type: "w", val: "FCOMP" },
		
		"InsStructSize":{ type: "u32", val: 0x34 },
		"OriginalInsCount": { type: "u32", val: 1395 },
		"NewInsCount": { type: "u32", val: 3 },
	},
	codecaves: {
		"ins_buffer": {
			size: "<option:InsStructSize>",
			count: "<option:OriginalInsCount> + <option:NewInsCount>",
			access: "rw"
		},
		"multibyte_nop_ins_data": {
			code:
//{ T("NOP"),         D_CMD, DX_NOP,         1, 0x000000FF, 0x00000090, 0x00,         B_NONE,         B_NONE,         B_NONE,         B_NONE }, 
//{ T("FCOM"),         D_FPU, 0,         2, 0x0000F8FF, 0x0000D0D8, 0x00,         B_ST0 | B_PSEUDO,         B_ST,         B_NONE,         B_NONE }, 
//{ T("FCOM"),         D_FPU, 0,         2, 0x0000FFFF, 0x0000D1D8, 0x00,         B_ST0 | B_PSEUDO,         B_ST1 | B_PSEUDO,         B_NONE,         B_NONE }, 
//{ T("FCOMP"),         D_FPU | D_FPUPOP, 0,         2, 0x0000F8FF, 0x0000D8D8, 0x00,         B_ST0 | B_PSEUDO,         B_ST,         B_NONE,         B_NONE }, 
//{ T("FCOMP"),         D_FPU | D_FPUPOP, 0,         2, 0x0000FFFF, 0x0000D9D8, 0x00,         B_ST0 | B_PSEUDO,         B_ST1 | B_PSEUDO,         B_NONE,         B_NONE }, 
"\
<option:LONG_NOP_WSTR>, <option:D_CMD>, <option:DX_NOP>, (u32:2), FFFF3800, 0F1F0000, (u32:0), (<option:B_INT> | <option:B_SHOWSIZE>), <option:B_NONE>, <option:B_NONE>, <option:B_NONE>, <option:NULL>, <RxC60EC>\
<option:NOP2_WSTR>, (<option:D_CMD> | <option:D_MUST66>), <option:DX_NOP>, (u32:1), FF000000, 0F1F0000, (u32:0), (<option:B_INT> | <option:B_SHOWSIZE>), <option:B_NONE>, <option:B_NONE>, <option:B_NONE>, <option:NULL>, <RxC60EC>\
<option:FCOM_WSTR>, (<option:D_FPU> | <option:D_UNDOC>), <option:DX_NONE>, (u32:2), FFF80000, DCD00000, (u32:0), (<option:B_ST0> | <option:B_PSEUDO>), <option:B_ST>, <option:B_NONE>, <option:B_NONE>, <option:NULL>, <option:NULL>\
"
		},
		"ins_patches": {
			code:
"\
(i32:0)<option:NewInsCount><codecave:multibyte_nop_ins_data>(i32:0)(i8:1)000000\
<option:OriginalInsCount>(u32:0)(i32:0)(i8:0)000000\
(i32:-1)(u32:0)(u32:0)(i32:0)(i8:0)000000\
",
			access: "r"
		},
		"build_ins_array_patch_init": {
			code:
"\
55 \\ \
53 \\ \
57 \\ \
56 \\ \
BE <codecave:ins_patches> \\ \
BF <codecave:ins_buffer> \\ \
B8 <RxF793C> \\ \
31C9 \\ \
EB 33 \\ \
<NOP:9> \\ \
...
",
	...
	binhacks: {
		"new_instr_array": {
			...
			code: "<codecave:ins_buffer>",
			expected: "<RxF793C>"
		},
		"ins_buffer_thing": {
			addr: "Rx3F26C",
			code: "(u32:(<option:OriginalInsCount> + <option:NewInsCount>) * 254)",
			expected: "(u32:0x56860)"
		}
	}
}